...
Процедура КомандаПодбор(Команда)
	...
	ОткрытьФорму("Документ.ПроведениеСоревнования.Форма.ПодборУчастников",Данные,ЭтотОбъект,Новый УникальныйИдентификатор,,,ОписаниеОповещения,КР_СерверныеСервер.ПолучитьРежимОткрытияФормыПодбора());
КонецПроцедуры
