...
Процедура ПриЗаполненииСпискаРеквизитовИсточникаСДатамиДляНапоминания(Источник, РеквизитыСДатами) Экспорт
	...
	Если ТипЗнч(Источник) = Тип("ДокументСсылка.ПроведениеСоревнования") 
		Или ТипЗнч(Источник) = Тип("ДокументСсылка.КорректировкаРейтинга") Тогда
		РеквизитыСДатами.Очистить();
		РеквизитыСДатами.Добавить("Дата");
	ИначеЕсли ТипЗнч(Источник) = Тип("СправочникСсылка.Участники") Тогда
		РеквизитыСДатами.Очистить();
	КонецЕсли;
